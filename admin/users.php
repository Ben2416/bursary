...
<div class="mainwrapper">
        ...
        <div class="datewidget">Today is Tuesday, Dec 25, 2012 5:30pm</div>
         ...
         <div class="leftmenu">        
            <ul class="nav nav-tabs nav-stacked">
                ...
                <li class="active animate6 fadeInUp"><a href="users.php"><span class="icon-picture"></span> Registered Users</a></li>
    ...
    <div class="rightpanel">
        ...
        <div class="pagetitle">
        	<h1>Registered Users</h1> <span>List of all registered Users</span>
        </div><!--pagetitle-->
                    ...
                    <tbody>
                        <!--<tr class="gradeX">
                          <td class="aligncenter"><span class="center">
                            ...
                            <td>Okpongu</td>
                            <td>Ebimobowei</td>
                            <td>ebi.okpongu@gmail.com</td>
                            <td class="center">07034428600</td>
